...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Get all the elements that has .randomPizzaContainer class
...
//Declares the variable outside the loop, so DOM call is made only once
...
function updatePositions() {
  ...
  //Declares the top variable outside the loop, so DOM call is made only once
